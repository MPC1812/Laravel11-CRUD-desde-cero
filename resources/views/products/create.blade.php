                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="relative overflow-x-auto">
                        ...
                        <form class="max-w-sm mx-auto" method="POST" action="{{ route('products.store') }}">
                            ...
                            <button type="submit"
                                class="mt-3 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Guardar</button>
                        </form>
